...
if any(arg in ('-h', '--help') for arg in sys.argv[1:]):
    parser = argparse.ArgumentParser(description='EMB-MPC 10-run average experiment')
    ...
    parser.add_argument('--n_models', type=int, default=5000, help='Number of models in the evolving bank')
    parser.add_argument('--adaptive_sampling_std', type=float, default=0.08, help='Adaptive bank sampling std ratio')
    parser.add_argument('--new_model_error_factor', type=float, default=1.1)
    parser.add_argument('--update_interval', type=int, default=150)
    parser.add_argument('--friction_update_delay', type=int, default=40)
    parser.add_argument('--stabilization_steps', type=int, default=1000)
